		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a class="btn-primary btn-radius btn-brd log" href="admin-view-drivers.jsp">View Drivers</a></li>
					<li><a class="btn-primary btn-radius btn-brd log" href="admin-view-ambulance.jsp">View Ambulances</a></li>
					...
					<li><a class="btn-primary btn-radius btn-brd log" href="admin-view-patient.jsp">View Patients</a></li>
